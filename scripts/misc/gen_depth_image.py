...
left_exr = "disparity_results/app_jerlov3C_f25_i008_shallow/raw depth0012_L.exr"

left_output = os.path.join(script_dir, "disparity_results/app_jerlov3C_f25_i008_shallow/left_disparity_vis.png")
